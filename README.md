...
- basic git commands :
  ...
  - setup new repo
    ...
    - push to github
      git remote add origin https://github.com/CMGraham23/christinetraveltips.git
git branch -M main
...
{
  /* <!-- map over pageLinks array --> */
}
{
  /* <!-- return a list item for each item in the array --> */
}
{
  /* <!-- use destructuring to access the properties --> */
}
{
  /* <!-- use the id as the key --> */
}
{
  /* <!-- use the href and text properties for the anchor tag --> */
}
{
  /* <!-- use the text property for the text content --> */
}
{
  /* <!-- use the href property for the href attribute --> */
}
{
  /* <!-- use the text property for the text content --> */
}
